...
<body>
  ...
  <div class="inner-page">
    <div class="slider-item overlay" style="background-image: url('images/gambar10.jpg');"
      data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row slider-text align-items-center justify-content-center">
          <div class="col-lg-9 text-center col-sm-12 element-animate">
            <h1 class="mb-4">Program Sambar Peduli</h1>
            <p class="custom-breadcrumbs"><a href="index.html">Beranda</a> <span class="mx-3">/</span> <a href="portfolio.html">Dokumentasi</a> <span class="mx-3">/</span> Program Sambar Peduli</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="section">
    <div class="container">
      <div class="row mb-5">
        <div class="col-lg-6">
          <img src="images/gambar7.jpg" alt="Image" class="img-fluid">
        </div>
        <div class="col-lg-5 ml-auto">
          <h3 class="mb-4">Sambar Peduli</h3>
          <p>Merupakan Kegiatan Bakti sosial berupa pembagian sembako untuk warga jemaat maupun warga sekitar gereja yang kurang mampu. Program kegiatan
            ini sebagai wujud pelayanan warga jemaat terhadap saudara-saudara yang secara khusus terdampak pandemi covid-19. Warga yang sekiranya ingin
          berpersembahan dapat mendaftar dan menghubungi kontak dibawah ini. </p>
          <ul class="list-unstyled mb-5">
            <li class="mb-3">
              <strong class="d-block text-black">Whatsapp Admin</strong>
              089673721223
            </li>
            <li>
              <strong class="d-block text-black">Telepon:</strong>
              (0274) 562477
            </li>
          </ul>


          <p><a href="{{route('contact')}}" class="btn btn-outline-black ">HUBUNGI</a></p>
        </div>
      </div>
      <!--
      <div class="row">
